	...
	$.recent = {	
		...
		preview : function(options){
			...
			$(".carousel-inner").click(function(event){
				...
				// product hit
				$('.recent_preview_hit').append(hit);
				
				// product name
				$(".recent_preview_title").append(productName);
				...
				$('.recent_preview_options').append(content);
				
				// product detail info
				if(simpleDescription != '') {
					$('.recent_preview_content').append(simpleDescription);
				} else if(summaryDescription != '') {
					$('.recent_preview_content').append(summaryDescription);
				} else {
					$('.recent_preview_content').append('간략 설명이 없습니다.');
				}
